...
\hyperlink{namespaceThis}{This} class creates an easy-\/to-\/call pair of sinusoids, pi/2 radians out of phase with each other, that will preserve its phase throughout its lifespan. Essentially, it is a ring buffer. 
