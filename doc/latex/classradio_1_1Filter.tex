...
\hyperlink{namespaceThis}{This} class implements a z-\/domain filter on a specified array of float32's (a.\+k.\+a. singles, floats). It requires the transfer function coefficients be already calculated (i.\+e., it does not generate the coefficients based on desired filter characteristics). M\+A\+T\+L\+A\+B and its Signal Processing Toolbox can be used to generate the coefficients.
